        ...
        return interaction.reply({
            embeds: Util.makeEmbed(true, interaction.user)
                .setDescription(
                    ...
                    "",
                    "**Other**:",
                    `${Config.emojis.default.dot} Library: [Oceanic@dev](https://github.com/OceanicJS/Oceanic/tree/${VERSION.slice(VERSION.lastIndexOf(".") + 1)}) (**${VERSION}**, \`${VERSION.split(".").slice(-1)[0]}\`)`,
