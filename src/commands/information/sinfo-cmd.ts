					...
					embeds: [
						new EmbedBuilder()
							...
							.setDescription(
								...
								`${emojis.default.dot} 2FA Requirement: **${names.mfaLevel[msg.channel.guild.mfaLevel]}**`,
								`${emojis.default.dot} Explicit Content Filter: **${names.explicitContentFilter[msg.channel.guild.explicitContentFilter]}**`,
								`${emojis.default.dot} Default Notifications: **${names.defaultNotifications[msg.channel.guild.defaultNotifications]}**`,
								...
								`${emojis.default.dot} NSFW level: ${names.nsfwLevel[msg.channel.guild.nsfwLevel]}`,
								"",
								"**Features**:",
