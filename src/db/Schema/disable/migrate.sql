ALTER TABLE `disable`
	...
	ADD COLUMN IF NOT EXISTS `type`          BIT(2)       NOT NULL,
	ADD COLUMN IF NOT EXISTS `filter_value`  TINYTEXT     DEFAULT NULL,
	ADD COLUMN IF NOT EXISTS `value`         VARCHAR(21)  DEFAULT NULL,
	ADD COLUMN IF NOT EXISTS `filter_type`   BIT(2)       NOT NULL,
	-- Indexes
