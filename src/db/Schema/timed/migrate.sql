ALTER TABLE `timed`
	...
	CREATE COLUMN IF NOT EXISTS `type`      TINYTEXT     NOT NULL,
	CREATE COLUMN IF NOT EXISTS `guild_id`  VARCHAR(21)  NOT NULL,
	CREATE COLUMN IF NOT EXISTS `user_id`   VARCHAR(21)  NOT NULL,
	CREATE COLUMN IF NOT EXISTS `time`      BIGINT(20)   NOT NULL,
	CREATE COLUMN IF NOT EXISTS `expiry`    BIGINT(20)   NOT NULL,
	-- Indexes
